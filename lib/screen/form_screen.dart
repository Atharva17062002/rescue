...
class FormScreen extends StatefulWidget {
  const FormScreen({Key? key, required this.personalid,required this.lname,required this.fname,required this.location,required this.description,required this.imageurl}) : super(key: key);
